# AWS ML DevOps Infrastructure
# This Terraform configuration creates a complete AWS infrastructure for ML model deployment
...
resource "aws_ecr_repository" "ml_model" {
  name                 = "${var.project_name}-${var.environment}-ml-model"
...
# IAM Policy for ECS Task (CloudWatch access)
